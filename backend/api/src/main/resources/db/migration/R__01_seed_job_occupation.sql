...
INSERT INTO jobs (name, occupation_id)
VALUES ('경영기획·전략·사업기획', (SELECT id FROM occupations WHERE name = '경영지원·사무')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('국내영업·B2B/B2C', (SELECT id FROM occupations WHERE name = '영업·영업관리')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('브랜드마케팅·IMC·PR', (SELECT id FROM occupations WHERE name = '마케팅·광고·PR')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('상품기획·MD', (SELECT id FROM occupations WHERE name = '상품기획·MD·바이어')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('기계·자동차 R&D', (SELECT id FROM occupations WHERE name = '연구개발(R&D)')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('백엔드·프론트엔드·풀스택', (SELECT id FROM occupations WHERE name = 'IT·개발')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('AI·ML·데이터사이언티스트', (SELECT id FROM occupations WHERE name = '데이터·AI')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('제품기획', (SELECT id FROM occupations WHERE name = '제품·서비스기획')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('생산관리·공정관리·공장운영', (SELECT id FROM occupations WHERE name = '생산·제조·품질')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('건축·토목·플랜트 설계', (SELECT id FROM occupations WHERE name = '건설·토목·설비')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('구매·소싱·자재관리', (SELECT id FROM occupations WHERE name = '구매·물류·SCM')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('은행원·텔러·여신·심사', (SELECT id FROM occupations WHERE name = '금융·보험·투자')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('UX/UI·서비스디자인', (SELECT id FROM occupations WHERE name = '디자인·크리에이티브')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('방송·영상제작', (SELECT id FROM occupations WHERE name = '미디어·콘텐츠·엔터테인먼트')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('교육기획·콘텐츠개발', (SELECT id FROM occupations WHERE name = '교육·이러닝')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('임상시험·CRO', (SELECT id FROM occupations WHERE name = '의료·헬스케어')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('정책기획·분석', (SELECT id FROM occupations WHERE name = '정부사업·공공')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('콜센터·고객상담·TM', (SELECT id FROM occupations WHERE name = '고객상담·서비스·CS')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('택배·배송·기사', (SELECT id FROM occupations WHERE name = '운전·운송·배송')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('요리사·조리사', (SELECT id FROM occupations WHERE name = '식음료·외식')),
...
INSERT INTO jobs (name, occupation_id)
VALUES ('스포츠마케팅·매니지먼트', (SELECT id FROM occupations WHERE name = '스포츠·레저')),
