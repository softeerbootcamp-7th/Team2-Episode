...
type DropIndicatorProps = {
    ...
    /**
     * ✅ root에 child로 붙일 때만 사용
     * (prev/next는 targetNode.addNodeDirection으로 판단 가능)
     */
...
export default function DropIndicator({ targetId, direction, nodeMap, side }: DropIndicatorProps) {
